...
=======
        ...
        public InventorySlot(ContentManager content, Microsoft.Xna.Framework.Vector2 position, IInventoryItem item, float scale, InventoryState inventory) : base(item.GetTexture(), position, 1)
        {
